...
@app.get("/api/v1/patches/catalog", dependencies=[Depends(verify_api_key)])
...
@app.post("/api/v1/patches/catalog", dependencies=[Depends(verify_api_key)])
...
@app.post("/api/v1/patches/catalog/import", dependencies=[Depends(verify_api_key)])
...
@app.patch("/api/v1/patches/catalog/{patch_id}/approve", dependencies=[Depends(verify_api_key)])
...
@app.patch("/api/v1/patches/catalog/{patch_id}/exclude", dependencies=[Depends(verify_api_key)])
...
@app.get("/api/v1/patches/catalog/{patch_id}", dependencies=[Depends(verify_api_key)])
...
@app.get("/api/v1/patches/compliance", dependencies=[Depends(verify_api_key)])
...
@app.get("/api/v1/patches/compliance/nodes", dependencies=[Depends(verify_api_key)])
...
@app.get("/api/v1/patches/rings", dependencies=[Depends(verify_api_key)])
...
@app.post("/api/v1/patches/rings", dependencies=[Depends(verify_api_key)])
...
@app.put("/api/v1/patches/rings/{ring_id}", dependencies=[Depends(verify_api_key)])
...
@app.delete("/api/v1/patches/rings/{ring_id}", dependencies=[Depends(verify_api_key)])
...
@app.get("/api/v1/patches/deployments", dependencies=[Depends(verify_api_key)])
...
@app.post("/api/v1/patches/deployments", dependencies=[Depends(verify_api_key)])
...
@app.get("/api/v1/patches/deployments/{deployment_id}", dependencies=[Depends(verify_api_key)])
...
@app.post("/api/v1/patches/deployments/{deployment_id}/pause", dependencies=[Depends(verify_api_key)])
...
@app.post("/api/v1/patches/deployments/{deployment_id}/resume", dependencies=[Depends(verify_api_key)])
...
@app.post("/api/v1/patches/deployments/{deployment_id}/cancel", dependencies=[Depends(verify_api_key)])
