...
> **Production Ready (v0.3.6)** — Zero-touch installation, hardware/software inventory, browser security analysis, remote command execution. Manage your Windows fleet from anywhere.
...
### 🍪 Browser Security Analysis (NEW in v0.3.6)
...
### ⏱️ System Monitoring (NEW in v0.3.6)
