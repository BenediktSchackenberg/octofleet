...
namespace OctofleetAgent.Services;

/// <summary>
/// Manages the Octofleet Node Windows Service
/// </summary>
public class ServiceController
{
    public const string ServiceName = "OctofleetNodeAgent";
    public const string DisplayName = "Octofleet Node Agent";
    public const string Description = "Octofleet Node Agent - Connects this PC to an Octofleet Gateway for remote command execution.";
    ...
    private static string ServiceExePath
    {
        get
        {
            ...
            var sameDir = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "OctofleetAgent.Service.exe");
            ...
            var devPath = Path.GetFullPath(Path.Combine(baseDir, "..", "..", "..", "..", 
                "OctofleetAgent.Service", "bin", "Debug", "net8.0-windows", "win-x64", "OctofleetAgent.Service.exe"));
            if (File.Exists(devPath)) return devPath;

            // Try without win-x64
            var devPath2 = Path.GetFullPath(Path.Combine(baseDir, "..", "..", "..", "..", 
                "OctofleetAgent.Service", "bin", "Debug", "net8.0-windows", "OctofleetAgent.Service.exe"));
